...
import com.bfsi.egalite.view.deposit.payments.PaymentAgenda;
import com.bfsi.egalite.view.deposit.payments.PaymentEntry;

public class DpPaymentView extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		adapter = new FragmentsAdapterPayment(getSupportFragmentManager());
	...
	class FragmentsAdapterPayment extends FragmentStatePagerAdapter {

		public FragmentsAdapterPayment(FragmentManager fm) {
			super(fm);
		}
		...
		public Fragment getItem(int position) {
			...
			case 1:
				return PaymentEntry.newInstance(DpPaymentView.this,mPager,mPageIndicator);
	...
	protected void onLeftAction() {
		...
		if (id == R.drawable.home && mPager.getCurrentItem() == 0) {
			Intent cash = new Intent(DpPaymentView.this, HomeView.class);
			startActivity(cash);
			finish();
	...
	private void handleBackPressed() {
			...
			{
				PaymentEntry fragment = (PaymentEntry)mRegisteredFragments.get(mPager.getCurrentItem());
