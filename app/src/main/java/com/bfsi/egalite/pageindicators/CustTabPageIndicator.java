...
/**
 * Widget implements the dynamic action bar tab behavior that can change
 * @author Vijay
 *
 */
public class CustTabPageIndicator extends HorizontalScrollView implements
		PageIndicator {
	...
	public CustTabPageIndicator(Context context) {
		this(context, null);
		mContext = context;
	}

	public CustTabPageIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
	...
	public void onPageSelected(int arg0) {
		...
		if (arg0 == 0) {
			...
			CommonContexts.CURRENT_SCREEN = CommonContexts.SCREEN_ENROLL_DETAILS;
			BaseActivity.mBtnRight.setVisibility(View.GONE);
			...
			CommonContexts.CURRENT_SCREEN = CommonContexts.SCREEN_BIOMETRIC;
			BaseActivity.mBtnRight.setVisibility(View.VISIBLE);
			BaseActivity.mTitle.setText(R.string.screen_enrol_new);
			BaseActivity.mBtnRight.setTag(R.drawable.save);
			BaseActivity.mBtnRight.setImageResource(R.drawable.save);
			BaseActivity.mBtnLeft.setTag(R.drawable.back);
			BaseActivity.mBtnLeft.setImageResource(R.drawable.back);
	...
	public void setCurrentItem(int item) {
		if (mViewPager == null) {
			throw new IllegalStateException(Constants.BFSI_VIEWPAGER_NOTBOUND);
		}
	...
	private class TabView extends TextView {
		...
		public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			...
			// Re-measure tab went beyond our maximum size.
