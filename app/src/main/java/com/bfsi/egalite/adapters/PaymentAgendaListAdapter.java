...
public class PaymentAgendaListAdapter extends BaseAdapter implements Filterable {
	private Context mContext;
	private LayoutInflater mLayoutInflater;
	private List<AgendaMaster> mPaymentAgendaList;
	private List<AgendaMaster> mDisplayedList;
	private PaymentAgendaListAdapter mlistAdapter;
	private ListView mListView;
	private BfsiViewPager mPager;
	private HolderFilter mHolderFilter;

	public PaymentAgendaListAdapter(Context context,
	...
	private void applySort(Comparator<AgendaMaster> comparator) {
		...
		mlistAdapter = new PaymentAgendaListAdapter(mContext, mDisplayedList,
				mListView, mPager);
	...
	private class HolderFilter extends Filter {
		...
		protected void publishResults(CharSequence constraint,
			...
			PaymentAgendaListAdapter.this.notifyDataSetChanged();
		}
	}
